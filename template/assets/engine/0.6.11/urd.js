...
import { tabellBlock } from './blocks/tabell.js';
import { delingBlock } from './blocks/deling.js';
import { nedtellerBlock } from './blocks/nedteller.js';
import { audioBlock } from './blocks/audio.js';
import { produktBlock } from './blocks/produkt.js';
import { handlekurvBlock } from './blocks/handlekurv.js';
import { kasseBlock } from './blocks/kasse.js';
...
function registerCore() {
  ...
  Urd.blocks.define('tabell', tabellBlock);
  Urd.blocks.define('deling', delingBlock);
  Urd.blocks.define('nedteller', nedtellerBlock);
  Urd.blocks.define('audio', audioBlock);
  Urd.blocks.define('produkt', produktBlock);
  Urd.blocks.define('handlekurv', handlekurvBlock);
  Urd.blocks.define('kasse', kasseBlock);
