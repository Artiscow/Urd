      ...
      blocks: [
        {
          ...
          animation: null,
          frames: { desktop: { x: 2, y: 5, w: 12, h: 4, z: 1, rot: 0 }, mobile: null },
        },
        {
          id: makeId('blk'),
          type: 'text',
          ...
          animation: null,
          frames: { desktop: { x: 2, y: 9, w: 10, h: 2, z: 1, rot: 0 }, mobile: null },
        },
        {
          id: makeId('blk'),
          type: 'button',
          ...
          animation: null,
          frames: { desktop: { x: 2, y: 12, w: 5, h: 2, z: 1, rot: 0 }, mobile: null },
        },
      ],
      responsive: autoMobile(),
    }),
      ...
      blocks: [
        {
          ...
          animation: null,
          frames: { desktop: { x: 6, y: 2, w: 12, h: 2, z: 1, rot: 0 }, mobile: null },
        },
      ],
      responsive: autoMobile(),
    }),
