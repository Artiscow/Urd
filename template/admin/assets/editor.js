...
function ba(e, t) {
			...
			var i = B(r, 2), o = (e) => {
				...
				var o = B(r, 2), s = (e) => {
					...
					Or(c, 17, () => W(C).nav.items, wr, (e, t, n) => {
						...
						}), G("input", a, (e) => At(n, e.target.value)), G("click", s, () => Nt(n, -1)), G("click", c, () => Nt(n, 1)), G("click", l, () => Pt(n)), G("change", u, (e) => jt(n, e.target.value)), q(e, r);
					});
					var l = B(c, 2);
					j(t), V(() => {
	...
	var On = B(Tn, 2), kn = (e) => {
		var t = _a(), n = R(t), r = B(R(n), 4), i = B(R(r));
		Q(i), j(r);
		var a = B(r, 2), o = B(R(a));
		Q(o), j(a);
		var s = B(a, 2), c = B(R(s));
...
//#endregion
//#region src/main.js
var xa = yr(ba, { target: document.getElementById("urd-admin") });
//#endregion
