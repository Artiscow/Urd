		...
		var t = xi(), n = R(t), i = (e) => {
			...
			var r = z(n, 2), i = (e) => {
				...
				var i = z(n, 2), a = (e) => {
					var t = li();
					let n;
					var r = z(R(t), 2), i = z(R(r), 2), a = z(i, 2);
					A(r);
					var o = z(r, 2), s = z(o, 2), c = z(R(s));
					A(s);
					var l = z(s, 2), u = z(R(l), 2), d = z(u, 2), f = z(d, 2), m = z(f, 2), h = z(m, 2);
					A(l), A(t), B(() => {
					...
					}), X("click", i, () => Re("text")), X("click", a, () => Re("text-box")), X("click", o, () => Re("button")), X("change", c, ze), X("click", u, () => Re("shape-line")), X("click", d, () => Re("shape-arrow")), X("click", f, () => Re("shape-circle")), X("click", m, () => Re("shape-rect")), X("click", h, () => Re("shape-triangle")), Q(e, t);
				}, o = (e) => {
