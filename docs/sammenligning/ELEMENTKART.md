...
**Urd i dag (23. september 2026):** to breakpoints. Desktop: bundet innholdsbredde med full-bredde seksjonsbakgrunn ([ADR-0018](../adr/0018-bound-content-width.md)), innholdsdytt som flytter blokkene under en blokk som vokser, og krymp-i-stedet-for-brekk per blokk ([ADR-0024](../adr/0024-content-push-on-the-desktop-canvas.md); sidezoomen fra ADR-0018-tillegget ble bygd og trukket 23. september 2026). Mobil: radgriden med synket overstyring per blokk ([ADR-0019](../adr/0019-synced-mobile-model.md)) + mobil-tilsyn (Urds svar på Wix Studios responsive-skanner). Forhåndsvisningen er festet til reelle enheter, der Skjerm følger eierens eget vindu eller en redigeringsstørrelse.
...
- **Navigasjon** (navbar, dropdown, mega meny, footer, site-deler). Tilbys: egne paneler + template parts. Bygges: disclosure-mønster (ADR-0010) eller Popover API + anchor positioning for menyer; ingen `role="menu"`. Elementgjennomgangen 22. september 2026 la til kunngjøringsstripe over nav (0.7.13.5) og lenkestarter i verktøyklyngen (0.7.13.6).
- **Dekorativt** (shapes, backgrounds, animasjoner). Tilbys: former som blokker, bakgrunnslag-editor. Bygges: SVG/CSS; scroll-drevne CSS-animasjoner bak `@supports`. Fra elementgjennomgangen 22. september 2026: bånd/marquee som blokk og gallerivisning (0.7.13.7), mønsterlag som inline-SVG-fliser og skilleformer mellom seksjoner (0.7.13.10).
