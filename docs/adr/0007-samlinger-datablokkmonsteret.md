...
4. **Tittel og innslagstekst er rik tekst.** (Revidert ved M2.5/M2.6, valgt 19. juli 2026.) Både `title` og `text` er sikker rik tekst med NØYAKTIG samme besøkende-vern som tekstblokkene (delt stripper i engine/sanitize.js: event-attributter, script/iframe/object/embed og javascript:-lenker fjernes ved rendering), og redigeres med den felles flytende teksteditoren rett i blokken.
