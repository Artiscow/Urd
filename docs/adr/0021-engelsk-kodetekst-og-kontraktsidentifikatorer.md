...
- Nettstedstemaenes preset-ider i editoren (aldri persistert; aktiv preset utledes fra tokens): bronn->well, stein->stone, plomme->plum, hav->ocean, natt->night, med themePreset.*-nøklene renamet i alle fem ordbøker.
