...
- **CSV-import/-eksport** (fra v0.7, funksjonskartet C12): Samlinger-panelet eksporterer innslagene som CSV og importerer en CSV-fil som ERSTATTER innslagene (første rad er kolonnenavnene; listefeltene `sizes`/`colors` skilles med `|`, fargebilder følger ikke med). Ren logikk i `engine/samlinger-csv.js`, som kun editoren bundler - besøkende laster den aldri.
