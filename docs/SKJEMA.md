...
- **`decor`** (valgfri, standard false): dekor-blokker (typisk streker/sirkler) utelates fra entré-animasjonens innholdsbølge (stagger). Fra schemaVersion 2 (ADR-0019) styrer feltet KUN animasjon; mobilskjulingen bor i `hideMobile`.
